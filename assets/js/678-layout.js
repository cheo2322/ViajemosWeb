...
var wpAjaxUrl = 'https://viajemosusa.com/wp-admin/admin-ajax.php';
var flBuilderUrl = 'https://viajemosusa.com/wp-content/plugins/bb-plugin/';
var FLBuilderLayoutConfig = {
    ...
    paths: {
        pluginUrl: 'https://viajemosusa.com/wp-content/plugins/bb-plugin/',
        wpAjaxUrl: 'https://viajemosusa.com/wp-admin/admin-ajax.php'
    },
    breakpoints: {
        small: 768,
        medium: 992
...
(function ($) {
    if ($(window).width() <= 768 && $(window).width() >= 481) {
        $('.fl-node-599d007dceb23 .pp-heading-separator, .fl-node-599d007dceb23 .pp-heading').removeClass('pp-center');
        $('.fl-node-599d007dceb23 .pp-heading-separator, .fl-node-599d007dceb23 .pp-heading').addClass('pp-tablet-center');
    }
    if ($(window).width() <= 480) {
        $('.fl-node-599d007dceb23 .pp-heading-separator, .fl-node-599d007dceb23 .pp-heading').removeClass('pp-center');
        $('.fl-node-599d007dceb23 .pp-heading-separator, .fl-node-599d007dceb23 .pp-heading').addClass('pp-mobile-center');
    }
})(jQuery);
(function ($) {
    if ($(window).width() <= 768 && $(window).width() >= 481) {
        $('.fl-node-5a206b509fddf .pp-heading-separator, .fl-node-5a206b509fddf .pp-heading').removeClass('pp-center');
        $('.fl-node-5a206b509fddf .pp-heading-separator, .fl-node-5a206b509fddf .pp-heading').addClass('pp-tablet-center');
    }
    if ($(window).width() <= 480) {
        $('.fl-node-5a206b509fddf .pp-heading-separator, .fl-node-5a206b509fddf .pp-heading').removeClass('pp-center');
        $('.fl-node-5a206b509fddf .pp-heading-separator, .fl-node-5a206b509fddf .pp-heading').addClass('pp-mobile-center');
    }
})(jQuery);
(function ($, window, undefined) {
    $(window).load(function () {
        $('.uabb-ih-container').css({
            'visibility': 'visible',
            'opacity': 1
        });
    });
...
(function ($) {
    if ($(window).width() <= 768 && $(window).width() >= 481) {
        $('.fl-node-5c7f4b0a62239 .pp-heading-separator, .fl-node-5c7f4b0a62239 .pp-heading').removeClass('pp-center');
        $('.fl-node-5c7f4b0a62239 .pp-heading-separator, .fl-node-5c7f4b0a62239 .pp-heading').addClass('pp-tablet-center');
    }
    if ($(window).width() <= 480) {
        $('.fl-node-5c7f4b0a62239 .pp-heading-separator, .fl-node-5c7f4b0a62239 .pp-heading').removeClass('pp-center');
        $('.fl-node-5c7f4b0a62239 .pp-heading-separator, .fl-node-5c7f4b0a62239 .pp-heading').addClass('pp-mobile-center');
    }
})(jQuery);
(function ($) {
    jQuery(document).ready(function () {});
